...
import com.tm.tarvemart.mainUI.Dashboard;
...
//    String salt="ZhraT96O"; // live
    String merchant_key="0mjWc4oH";
    String salt="kztO1oahjB";
...
//    String salt="zhoXe53j"; // test
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(empty(params.get("txnid"))){
            ...
            Toast.makeText(getApplicationContext(),""+txnid,Toast.LENGTH_LONG).show();
        ...
        public void success(long id, final String paymentId) {
            mHandler.post(new Runnable() {
                public void run() {
                    ...
                    Intent intent=new Intent(PayMentGateWay.this, Dashboard.class);
        ...
        public void failure(final String params) {
            mHandler.post(new Runnable() {
                ...
                public void run() {
	                    ...
	                    finish();*/
                    Toast.makeText(getApplicationContext(),"Failed payment" +params,Toast.LENGTH_LONG).show();
                }
            });
        }
    }
